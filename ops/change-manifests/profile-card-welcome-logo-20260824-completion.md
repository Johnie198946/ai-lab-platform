...
- status: `DEPLOYED`
- commit SHA: `dd76e579cb95c4d37a2d35f8f3ab885c051608c6`。
- GitHub remote/ref/SHA: `origin refs/heads/main dd76e579cb95c4d37a2d35f8f3ab885c051608c6`，已使用 `git ls-remote` 核对。
...
- server_after: `/opt/ai-lab-platform/.deployed-sha=dd76e579cb95c4d37a2d35f8f3ab885c051608c6`；API、frontend、workers、Postgres、Redis 均健康/运行。
- health_check: `scripts/update.sh dd76e579cb95c4d37a2d35f8f3ab885c051608c6` 通过 API 健康检查和 `runtime contract audit`；部署后 API `/health` 返回 `{"status":"ok","version":"0.8.0"}`，Hermes Bridge active。
