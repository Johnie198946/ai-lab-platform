...
export default function ArchitectPage() {
  ...
  const send = async (event) => {
    ...
    if (!draft.trim() || !workflow) return;
    setBusy(true);
    setError("");
    try {
      await platformApi.answerClarification(workflow.id, draft.trim());
      setDraft("");
